...
func configureFlags(api *operations.JinlinonlineActivityAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.JinlinonlineActivityAPI) http.Handler {
	...
	api.HomeNrHomeHandler = home.NrHomeHandlerFunc(func(params home.NrHomeParams) middleware.Responder {
		return middleware.NotImplemented("operation home.NrHome has not yet been implemented")
	})
	...
	api.PraiseNrPraiseClickHandler = praise.NrPraiseClickHandlerFunc(func(params praise.NrPraiseClickParams) middleware.Responder {
		return middleware.NotImplemented("operation praise.NrPraiseClick has not yet been implemented")
	})
	api.PraiseNrPraiseListHandler = praise.NrPraiseListHandlerFunc(func(params praise.NrPraiseListParams) middleware.Responder {
		return middleware.NotImplemented("operation praise.NrPraiseList has not yet been implemented")
	})
	...
	api.SpareNrSpareClickHandler = spare.NrSpareClickHandlerFunc(func(params spare.NrSpareClickParams) middleware.Responder {
		return middleware.NotImplemented("operation spare.NrSpareClick has not yet been implemented")
	})
	api.SpareNrSpareListHandler = spare.NrSpareListHandlerFunc(func(params spare.NrSpareListParams) middleware.Responder {
		return middleware.NotImplemented("operation spare.NrSpareList has not yet been implemented")
	})
	api.StartUpNrStartUpHandler = start_up.NrStartUpHandlerFunc(func(params start_up.NrStartUpParams) middleware.Responder {
		return middleware.NotImplemented("operation start_up.NrStartUp has not yet been implemented")
	})
