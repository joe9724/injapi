...
func (o *CategoryListOK) WithPayload(payload *models.InlineResponse20011) *CategoryListOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the category list o k response
func (o *CategoryListOK) SetPayload(payload *models.InlineResponse20011) {
	o.Payload = payload
}
