...
func (o *MemberRegisterSendSmsOK) WithPayload(payload *models.InlineResponse2003) *MemberRegisterSendSmsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the member register send sms o k response
func (o *MemberRegisterSendSmsOK) SetPayload(payload *models.InlineResponse2003) {
	o.Payload = payload
}
