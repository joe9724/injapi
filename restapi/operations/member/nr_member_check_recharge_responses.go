...
func (o *MemberCheckRechargeOK) WithPayload(payload *models.InlineResponse2003) *MemberCheckRechargeOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the member check recharge o k response
func (o *MemberCheckRechargeOK) SetPayload(payload *models.InlineResponse2003) {
	o.Payload = payload
}
