...
func (o *ActivityListFavOK) WithPayload(payload *models.InlineResponse2007) *ActivityListFavOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the activity list fav o k response
func (o *ActivityListFavOK) SetPayload(payload *models.InlineResponse2007) {
	o.Payload = payload
}
