...
func (o *ActivityListSponsorOK) WithPayload(payload *models.InlineResponse2009) *ActivityListSponsorOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the activity list sponsor o k response
func (o *ActivityListSponsorOK) SetPayload(payload *models.InlineResponse2009) {
	o.Payload = payload
}
